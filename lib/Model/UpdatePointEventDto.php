...
/**
 * UpdatePointEventDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdatePointEventDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePointEventDto';
     ...
     * Sets verb
     *
     * @param string|null $verb The verb to display along with the point event in user interfaces. For example: \"You connected Facebook\"
     *
     * @return self
     */
     ...
     * Sets platform
     *
     * @param string|null $platform Social platform (twitter, instagram, facebook) or other external platform where the event was awarded from
     *
     * @return self
     */
     ...
     * Sets is_burn
     *
     * @param bool|null $is_burn For awarding points, set this to false. Set to true if you want to consume points instead of awarding them
     *
     * @return self
     */
     ...
     * Sets points
     *
     * @param float|null $points Number of points to award for this event.
     *
     * @return self
     */
     ...
     * Sets timestamp
     *
     * @param \DateTime|null $timestamp For displaying to the user, the related time when the points were awarded.
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param object|null $metadata Any custom metadata
     *
     * @return self
     */
